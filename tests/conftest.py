...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "euclidean_time_horizon: tests for core.euclidean.TimeHorizon")
    config.addinivalue_line("markers", "euclidean_phase_space: tests for core.euclidean.PhaseSpace")
